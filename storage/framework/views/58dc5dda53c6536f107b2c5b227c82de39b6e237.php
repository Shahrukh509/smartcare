  ...
  <!-- /.card-header -->
  <div class="card-body">
  <form id="survey_add" action="<?php echo e(route('survey.question.add',$id)); ?>" method="post">
  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smartcare\resources\views/survey/add_survey_question.blade.php ENDPATH**/ ?>